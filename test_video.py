...
parser.add_argument('--transform_path', type=str, default='/experiments/sa_module_iter_100000.pth')
...
decoder_path='./experiments/decoder_iter_100000.pth'
transform_path='./experiments/sa_module_iter_100000.pth'
# Additional options
content_size=512
style_size=512
crop='store_true'
...
for k, v in state_dict.items():
    ...
    namekey = k
    new_state_dict[namekey] = v
sa_module.load_state_dict(new_state_dict)
