...
parser.add_argument('--decoder_path', type=str, default='./models/decoder_iter_160000.pkl')
parser.add_argument('--transform_path', type=str, default='./models/mcc_module_iter_160000.pkl')
...
decoder.load_state_dict(jt.load(args.decoder_path))
mcc_module.load_state_dict(jt.load(args.transform_path))  
